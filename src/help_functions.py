...
def masks_colorize(masks, N_classes=6):
    ...
    if (N_classes == 4):
        colors = {0: np.array([0, 0, 0]), 1: np.array([0, 128, 0]), 2: np.array([0, 255, 0]),
                  3: np.array([255, 255, 255])}
    else:
        colors = {0: np.array([0, 0, 0]), 1: np.array([64, 64, 64]), 2: np.array([0, 0, 255]), 3: np.array([0, 128, 0]),
                  4: np.array([0, 255, 0]), 5: np.array([255, 255, 255])}
