...
def get_data_training(p_train_imgs_original,
    ...
    train_groundTruth = p_train_groundTruth
...
# Load the original data and return the extracted patches for training/testing
def get_data_testing(p_test_imgs_original, p_test_groundTruth, Imgs_to_test, patch_height, patch_width):
    test_imgs_original = p_test_imgs_original
    test_masks = p_test_groundTruth
...
def get_data_testing_overlap(DRIVE_test_imgs_original, DRIVE_test_groundTruth, Imgs_to_test, patch_height, patch_width,
                             stride_height, stride_width):
    test_imgs_original = load_hdf5(DRIVE_test_imgs_original)
    test_masks = load_hdf5(DRIVE_test_groundTruth)
...
def recombine_overlap(preds, img_h, img_w, stride_h, stride_w):
