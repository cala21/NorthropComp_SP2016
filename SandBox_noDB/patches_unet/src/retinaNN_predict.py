...
db = DatabaseProxy()
_, _ , patches_imgs_testx, patches_masks_testx = db.getTestAndTrainingData(batches=32)
...
if average_mode == False:
    patches_imgs_test, patches_masks_test = get_data_testing(
        p_test_imgs_original = patches_imgs_testx,  #original
...
#    pred_imgs = recompone(pred_patches,32,32)       # predictions
#    orig_imgs = recompone(patches_imgs_test,32,32)  # originals
#    gtruth_masks = recompone(patches_masks_test,32,32)  #masks
