...
def get_unet(n_ch, patch_height, patch_width):
    ...
    #
    conv6 = Convolution2D(5, 1, 1, activation='relu',
                          border_mode='same')(conv5)
    conv6 = core.Reshape((5, patch_height * patch_width))(conv6)
...
def get_1d(n_ch, patch_height, patch_width):
    ...
    #
    conv6 = Convolution1D(1, 1, activation='relu', border_mode='same')(conv5)
...
#print(patches_imgs_train.shape[1])
#print(patches_imgs_train.shape[0])
